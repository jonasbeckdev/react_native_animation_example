...
import {popW2} from '../redux/actions'
                    ...
                    this.props.table.cards.map((card, i)=>{
                        return (
                            ...
                            <Card
                                ...
                                releaseOn={(to, yes, no)=>{
                                    this.props.releaseOn(ground.w2, to, yes, no)
                                }}
                                setDragging={()=>{
                                    this.props.setDragging(this.id)
                                }}
                                moveOn={(to)=>{
                                    return logicRlease(ground.w2, to)
                                }}
...
export default connect(mapStateToProps, {popW2})(W2);
