...
import {popB2} from '../redux/actions'
                    ...
                    this.props.table.cards.map((card, i)=>{
                        return (
                            ...
                            <Card
                                ...
                                releaseOn={(to, yes, no)=>{
                                    this.props.releaseOn(ground.b2, to, yes, no)
                                }}
                                setDragging={()=>{
                                    this.props.setDragging(this.id)
                                }}
                                moveOn={(to)=>{
                                    return logicRlease(ground.b2, to)
                                }}
...
export default connect(mapStateToProps, {popB2})(B2);
