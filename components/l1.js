...
import {popL1} from '../redux/actions'
                    ...
                    this.props.table.cards.map((card, i)=>{
                        return (
                            ...
                            <Card
                                ...
                                releaseOn={(to, yes, no)=>{
                                    this.props.releaseOn(ground.l1, to, yes, no)
                                }}
                                setDragging={()=>{
                                    this.props.setDragging(this.id)
                                }}
                                moveOn={(to)=>{
                                    return logicRlease(ground.l1, to)
                                }}
...
export default connect(mapStateToProps, {popL1})(L1);
