...
import {popB3} from '../redux/actions'
                    ...
                    this.props.table.cards.map((card, i)=>{
                        return (
                            ...
                            <Card
                                ...
                                releaseOn={(to, yes, no)=>{
                                    this.props.releaseOn(ground.b3, to, yes, no)
                                }}
                                setDragging={()=>{
                                    this.props.setDragging(this.id)
                                }}
                                moveOn={(to)=>{
                                    return logicRlease(ground.b3, to)
                                }}
...
export default connect(mapStateToProps, {popB3})(B3);
